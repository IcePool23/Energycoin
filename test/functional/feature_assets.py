...
class AssetTest(NrgcTestFramework):
    ...
    def big_test(self):
        ...
        n0.listassets(asset="NRGC*", verbose=False, count=2, start=-2)
        ...
        nrgc_assets = n0.listassets(asset="NRGC*", verbose=False, count=2, start=-2)
        assert_equal(len(nrgc_assets), 2)
        assert_equal(nrgc_assets[0], "NRGC2")
        assert_equal(nrgc_assets[1], "NRGC3")
        self.sync_all()
