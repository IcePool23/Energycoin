...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the NrgcTestFramework
    pass

class ExampleTest(NrgcTestFramework):
    # Each functional test is a subclass of the NrgcTestFramework class.
    ...
    def custom_method(self):
        ...
        NrgcTestFramework class so other tests can use it."""
