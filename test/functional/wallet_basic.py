...
class WalletTest(NrgcTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 NRGC from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 NRGC with subtract fee from amount
        ...
        # Sendmany 10 NRGC with subtract fee from amount
