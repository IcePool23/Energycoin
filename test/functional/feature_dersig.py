...
class BIP66Test(NrgcTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # nrgcd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and nrgcd produces more specific reject
            # reasons.
