...
class TxnMallTest(NrgcTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 NRGC:
        ...
        # First: use raw transaction API to send 1240 NRGC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 NRGC coin each
        ...
        # Node0's balance should be starting balance, plus 50NRGC for another
        ...
        # Node0's total balance should be starting balance, plus 100NRGC for 
