...
class TestNrgcCli(NrgcTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `nrgc-cli getinfo`")
        ...
        self.log.info("Compare responses from `nrgc-cli -getinfo` and the RPCs data is retrieved from.")
