...
# TestNode: A peer we use to send messages to nrgcd, and store responses.
...
class CompactBlocksTest(NrgcTestFramework):
    ...
    # This test actually causes nrgcd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that nrgcd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for nrgcd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # nrgcd will not send blocktxn responses for blocks whose height is
