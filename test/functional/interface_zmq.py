...
import os
import struct
from test_framework.test_framework import NrgcTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(NrgcTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that nrgc has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("nrgcd has not been built with zmq enabled.")
