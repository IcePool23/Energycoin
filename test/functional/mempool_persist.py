...
By default, nrgcd will dump mempool on shutdown and
...
class MempoolPersistTest(NrgcTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give nrgcd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent nrgcd from writing mempool.dat to disk. Verify that `savemempool` fails")
