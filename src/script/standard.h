...
#ifndef NRGC_SCRIPT_STANDARD_H
#define NRGC_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_NRGC_ASSET script that carries data
    /** NRGC END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a nrgccoin address
 */
...
/**
 * Generate a Nrgc scriptPubKey for the given CTxDestination. Returns a P2PKH
