...
#ifndef ENERGYCOIN_ASSET_PROTOCOL_H
#define ENERGYCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_NRGC_ASSET NRGCQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_NRGC_ASSET NRGCO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_NRGC_ASSET NRGCR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_NRGC_ASSET NRGCT
...
#endif //ENERGYCOIN_ASSET_PROTOCOL_H
