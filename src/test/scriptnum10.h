...
#ifndef NRGC_TEST_SCRIPTNUM10_H
#define NRGC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Nrgc Core 0.10.0, for cross-comparison.
 */
public:
