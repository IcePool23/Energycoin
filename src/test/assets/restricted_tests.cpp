...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler nrgc tx
        CScript nrgcTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut nrgcOut(1*COIN, nrgcTransfer);
        ...
        mutTxTest1.vout.emplace_back(nrgcOut);
        ...
        mutTxTest2.vout.emplace_back(nrgcOut);
        ...
        mutTxTest3.vout.emplace_back(nrgcOut);
        ...
        mutTxTest4.vout.emplace_back(nrgcOut);
        ...
        mutTxTest5.vout.emplace_back(nrgcOut);
        ...
        mutTxTest6.vout.emplace_back(nrgcOut);
        ...
        mutTxTest7.vout.emplace_back(nrgcOut);
        ...
        mutTxTest8.vout.emplace_back(nrgcOut);
