...
#ifndef NRGC_QT_GUIUTIL_H
#define NRGC_QT_GUIUTIL_H
...
/** Utility functions used by the Nrgc Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "nrgc:" URI into recipient object, return true on successful parsing
