...
#ifndef NRGC_QT_NRGCGUI_H
#define NRGC_QT_NRGCGUI_H
...
/**
  Nrgc GUI main class. This class represents the main window of the Nrgc UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NrgcGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NrgcGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~NrgcGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a nrgc wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    QComboBox *comboNrgcUnit = nullptr;
