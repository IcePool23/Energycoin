    ...
    mapper(0)
{
    ...
    ui->nrgcAtStartup->setToolTip(ui->nrgcAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->nrgcAtStartup->setText(ui->nrgcAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openNrgcConfButton->setToolTip(ui->openNrgcConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new NrgcUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->nrgcAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openNrgcConfButton_clicked()
{
