...
#ifndef NRGC_QT_NRGCUNITS_H
#define NRGC_QT_NRGCUNITS_H
...
/** Nrgc unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NrgcUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NrgcUnits(QObject *parent);
...
typedef NrgcUnits::Unit NrgcUnit;

#endif // NRGC_QT_NRGCUNITS_H
