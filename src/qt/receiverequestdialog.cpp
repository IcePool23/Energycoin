...
#include "config/nrgc-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatNrgcURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + NrgcUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatNrgcURI(info));
}
