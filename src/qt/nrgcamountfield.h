...
#ifndef NRGC_QT_NRGCAMOUNTFIELD_H
#define NRGC_QT_NRGCAMOUNTFIELD_H
...
/** Widget for entering nrgc amounts.
  */
class NrgcAmountField: public QWidget
{
    Q_OBJECT
...
public:
    explicit NrgcAmountField(QWidget *parent = 0);
...
#endif // NRGC_QT_NRGCAMOUNTFIELD_H
