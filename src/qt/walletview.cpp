...
void WalletView::setNrgcGUI(NrgcGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? NrgcGUI::HD44_ENABLED : _walletModel->hdEnabled() ? NrgcGUI::HD_ENABLED : NrgcGUI::HD_DISABLED);
