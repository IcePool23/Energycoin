...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<NrgcAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_nrgc-qt -platform xcb      # Linux
//     src/qt/test/test_nrgc-qt -platform windows  # Windows
//     src/qt/test/test_nrgc-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = NrgcUnits::formatWithUnit(unit, balance, false, NrgcUnits::separatorAlways);
    ...
    // Amount input
    NrgcAmountField* amountInput = receiveCoinsDialog.findChild<NrgcAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: nrgc:")) != -1);
