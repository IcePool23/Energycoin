...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(NrgcUnits::NRGC),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->nrgcBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->nrgcBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(NrgcUnits::formatWithUnit(unit, balance, false, NrgcUnits::separatorAlways));
    ui->labelUnconfirmed->setText(NrgcUnits::formatWithUnit(unit, unconfirmedBalance, false, NrgcUnits::separatorAlways));
    ui->labelImmature->setText(NrgcUnits::formatWithUnit(unit, immatureBalance, false, NrgcUnits::separatorAlways));
    ui->labelTotal->setText(NrgcUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, NrgcUnits::separatorAlways));
    ui->labelWatchAvailable->setText(NrgcUnits::formatWithUnit(unit, watchOnlyBalance, false, NrgcUnits::separatorAlways));
    ui->labelWatchPending->setText(NrgcUnits::formatWithUnit(unit, watchUnconfBalance, false, NrgcUnits::separatorAlways));
    ui->labelWatchImmature->setText(NrgcUnits::formatWithUnit(unit, watchImmatureBalance, false, NrgcUnits::separatorAlways));
    ui->labelWatchTotal->setText(NrgcUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, NrgcUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("NRGC")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the NRGC balance grid from expanding and looking terrible when asset balance is hidden
