...
find ${DISTNAME}/bin -type f -executable -exec ../nrgccoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../nrgccoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/nrgccoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/nrgccoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
