...
This document provides guidelines for internationalization of the Nrgc Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nrgc_en.ts` remains unchanged.
