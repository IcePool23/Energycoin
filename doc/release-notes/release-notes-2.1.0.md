Nrgc Core version *2.1.0* is now available!!
==============

  <https://github.com/NrgcProject/Nrgccoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/NrgcProject/Nrgccoin/commits/release_2.1.0>
